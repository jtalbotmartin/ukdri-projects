# 1/7/24 generating correlation plots for dge results 
...
setwd("/Volumes/jmm17/projects/ukdrmultiomicsproject/live/MAP_analysis/TREM2_unenriched_scflow/dge/full_cohort/correlation_figures")
