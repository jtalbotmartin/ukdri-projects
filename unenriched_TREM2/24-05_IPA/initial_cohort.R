# 3/6/24 running IPA analysis from DEGs of initial cohort for Biogen (generated using common geneset)
...
setwd("/Volumes/jmm17/projects/ukdrmultiomicsproject/live/MAP_analysis/TREM2_unenriched_scflow/ipa/initial_cohort/Pathway_Analysis_CommonSet")
